...
Check out the markdown file [`welcome.md`](https://github.com/CodinGame/java-template/blob/master/markdowns/welcome.md) to see how this exercise is injected into the template.

# Template Resources

[`markdowns/welcome.md`](https://github.com/CodinGame/java-template/blob/master/markdowns/welcome.md)
What you are reading here is generated by this file. Tech.io uses the [Markdown syntax](https://tech.io/doc/reference-markdowns) to render text, media and to inject programming exercises.


[`java-project`](https://github.com/CodinGame/java-template/tree/master/java-project)
...
[`techio.yml`](https://github.com/CodinGame/java-template/blob/master/techio.yml)
